...
public abstract class BoxAndWhiskerCalculator
{
  ...
  public static BoxAndWhiskerItem calculateBoxAndWhiskerStatistics(List values, boolean stripNullAndNaNItems)
  {
    ...
    double upperOutlierThreshold = q3 + interQuartileRange * 1.5D;
    double lowerOutlierThreshold = q1 - interQuartileRange * 1.5D;
    
    double upperFaroutThreshold = q3 + interQuartileRange * 2.0D;
    double lowerFaroutThreshold = q1 - interQuartileRange * 2.0D;
