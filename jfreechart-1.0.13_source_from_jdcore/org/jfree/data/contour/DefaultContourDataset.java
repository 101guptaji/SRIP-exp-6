  ...
  implements ContourDataset
{
  ...
  public void initialize(Object[] xData, Object[] yData, Object[] zData)
  {
    ...
    for (int k = 0; k < xValues.length; k++) {
      if (xData[k] != null) { Number xNumber;
        Number xNumber;
        ...
        xValues[k] = new Double(xNumber.doubleValue());
  ...
  public Range getZValueRange(Range x, Range y)
  {
    ...
    double zMax = -1.0E20D;
    for (int k = 0; k < zValues.length; k++) {
      if ((xValues[k].doubleValue() >= minX) && (xValues[k].doubleValue() <= maxX) && (yValues[k].doubleValue() >= minY) && (yValues[k].doubleValue() <= maxY))
      {
