  ...
  implements Cloneable, Serializable
{
  ...
  public int getIndex(RegularTimePeriod period)
  {
    ...
    TimeSeriesDataItem dummy = new TimeSeriesDataItem(period, -2.147483648E9D);
  ...
  public void removeAgedItems(boolean notify)
  {
    if (getItemCount() > 1) {
      ...
      while (latest - getTimePeriod(0).getSerialIndex() > maximumItemAge) {
        data.remove(0);
        removed = true;
      }
      if ((removed) && (notify)) {
  ...
  public void removeAgedItems(long latest, boolean notify)
  {
    ...
    try {
      Method m = class$org$jfree$data$time$RegularTimePeriod.getDeclaredMethod("createInstance", new Class[] { Class.class, Date.class, TimeZone.class });
      

      RegularTimePeriod newest = (RegularTimePeriod)m.invoke(timePeriodClass, new Object[] { timePeriodClass, new Date(latest), TimeZone.getDefault() });
    ...
    while ((getItemCount() > 0) && (index - getTimePeriod(0).getSerialIndex() > maximumItemAge)) {
      data.remove(0);
      removed = true;
    }
    if ((removed) && (notify)) {
  ...
  public boolean equals(Object object)
  {
    ...
    if (!ObjectUtilities.equal(timePeriodClass, timePeriodClass))
    {
      return false;
    }
  ...
  public int hashCode()
  {
    ...
    result = 29 * result + (timePeriodClass != null ? timePeriodClass.hashCode() : 0);
