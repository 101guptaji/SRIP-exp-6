  ...
  extends DateFormat
{
  ...
  public StringBuffer format(Date date, StringBuffer toAppendTo, FieldPosition fieldPosition)
  {
    ...
    toAppendTo.append(months[month]);
    if (showYear[month] != 0) {
      toAppendTo.append(yearFormatter.format(date));
    }
    return toAppendTo;
  }
  ...
  public boolean equals(Object obj)
  {
    ...
    if (!Arrays.equals(months, months)) {
      return false;
    }
    if (!Arrays.equals(showYear, showYear)) {
      return false;
    }
    if (!yearFormatter.equals(yearFormatter)) {
      return false;
    }
    return true;
  }
