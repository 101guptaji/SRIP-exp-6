  ...
  implements XYItemRenderer, Cloneable, PublicCloneable, Serializable
{
  ...
  public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea, PlotRenderingInfo info, XYPlot plot, ValueAxis domainAxis, ValueAxis rangeAxis, XYDataset dataset, int series, int item, CrosshairState crosshairState, int pass)
  {
    ...
    double transY1 = Double.isNaN(y1) ? NaN.0D : rangeAxis.valueToJava2D(y1, dataArea, yAxisLocation);
    ...
    if ((pass == 0) && (item > 0))
    {
      ...
      double transY0 = Double.isNaN(y0) ? NaN.0D : rangeAxis.valueToJava2D(y0, dataArea, yAxisLocation);
      ...
      if (orientation == PlotOrientation.HORIZONTAL) {
        if (transY0 == transY1)
        {
          ...
          drawLine(g2, workingLine, transY0, transX0, transY1, transX1);
        ...
        else
        {
          ...
          drawLine(g2, workingLine, transY0, transX0, transY0, transXs);
          
          drawLine(g2, workingLine, transY0, transXs, transY1, transXs);
          
          drawLine(g2, workingLine, transY1, transXs, transY1, transX1);
        }
        ...
        if (transY0 == transY1)
        {
          drawLine(g2, workingLine, transX0, transY0, transX1, transY1);
        ...
        else
        {
          ...
          drawLine(g2, workingLine, transX0, transY0, transXs, transY0);
          
          drawLine(g2, workingLine, transXs, transY0, transXs, transY1);
          
          drawLine(g2, workingLine, transXs, transY1, transX1, transY1);
        }
      }
  ...
  public int hashCode()
  {
    return HashUtilities.hashCode(super.hashCode(), stepPoint);
  }
