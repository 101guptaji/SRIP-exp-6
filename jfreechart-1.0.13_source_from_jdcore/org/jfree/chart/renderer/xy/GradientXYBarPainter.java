  ...
  implements XYBarPainter, Serializable
{
  ...
  public void paintBar(Graphics2D g2, XYBarRenderer renderer, int row, int column, RectangularShape bar, RectangleEdge base)
  {
    ...
    Color c1;
    Color c0;
    Color c1; if ((itemPaint instanceof Color)) {
      Color c0 = (Color)itemPaint;
      c1 = c0.brighter();
    } else { Color c1;
      if ((itemPaint instanceof GradientPaint)) {
        GradientPaint gp = (GradientPaint)itemPaint;
        Color c0 = gp.getColor1();
        c1 = gp.getColor2();
      }
      else {
        c0 = Color.blue;
    ...
    if ((base == RectangleEdge.TOP) || (base == RectangleEdge.BOTTOM)) {
      Rectangle2D[] regions = splitVerticalBar(bar, g1, this.g2, g3);
      ...
      Rectangle2D[] regions = splitHorizontalBar(bar, g1, this.g2, g3);
  ...
  {
    int hash = 37;
    hash = HashUtilities.hashCode(hash, g1);
    hash = HashUtilities.hashCode(hash, g2);
    hash = HashUtilities.hashCode(hash, g3);
    return hash;
  }
}
