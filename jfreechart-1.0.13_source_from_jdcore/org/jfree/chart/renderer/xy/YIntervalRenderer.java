  ...
  implements XYItemRenderer, Cloneable, PublicCloneable, Serializable
{
  ...
  {
    additionalItemLabelGenerator = generator;
    fireChangeEvent();
  }
  ...
  {
    if (additionalItemLabelGenerator == null) {
      return;
    }
    ...
    g2.setPaint(paint);
    String label = additionalItemLabelGenerator.generateLabel(dataset, series, item);
  ...
  public boolean equals(Object obj)
  {
    ...
    if (!ObjectUtilities.equal(additionalItemLabelGenerator, additionalItemLabelGenerator))
    {
      return false;
    }
