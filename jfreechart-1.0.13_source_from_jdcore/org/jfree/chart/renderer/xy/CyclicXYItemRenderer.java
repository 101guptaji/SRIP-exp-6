  ...
  implements Serializable
{
  ...
  public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea, PlotRenderingInfo info, XYPlot plot, ValueAxis domainAxis, ValueAxis rangeAxis, XYDataset dataset, int series, int item, CrosshairState crosshairState, int pass)
  {
    ...
    double xcycleBound = NaN.0D;
    double ycycleBound = NaN.0D;
    boolean xBoundMapping = false;boolean yBoundMapping = false;
    CyclicNumberAxis cnax = null;CyclicNumberAxis cnay = null;
    ...
    implements XYDataset
  {
    ...
    {
      return delegateSet.getSeriesKey(series);
    }
    ...
    {
      return delegateSet.indexOf(seriesName);
    }
